...
- [Bug report](https://github.com/burkybang/SuiteAdvanced-Feedback/issues/new?assignees=burkybang&labels=bug&template=bug_report.md)
- [Feature request](https://github.com/burkybang/SuiteAdvanced-Feedback/issues/new?assignees=burkybang&labels=enhancement&template=feature_request.md)